...
uint256 hashGenesisBlock("0x0bfd8a13de552919fcc271bf8208ad00e769521f998d1eacbba2f0a2098693ae");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 20000); // StonkCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // StonkCoin: 1 days
static const int64 nTargetSpacing = 1 * 60; // StonkCoin: 1 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf1e4183b8214dde21696cb1658a4049f18d56ecf3a3ffe2a123770f6c6467882");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Stonks Enterprises - STAP investing in other sgit TM - vmajx";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 69 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("044cc708abe53c752208c98105c89b5081b2852c97e1bc00203c09bce26f0b0659944aa08ea43acef4b92dc435d529bcbeb98fcac7f59519420f8fb7ce548cd709") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1567505486;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085780977;

        if (fTestNet)
        {
            block.nTime    =1567505486;
            block.nNonce   = 386416072;
        }
	...
	if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x7d5b47b99fb087c7bb0fbec4ceea2241909ff0c8c523c9716ad30a0cec21834d"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xff, 0xc2, 0xb1, 0xd3 }; // StonkCoin: increase each by adding 2 to bitcoin's value.
